                ...
                <div class="col-sm-5">
                 ...
                 <div class="col-sm-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="nearby.php">Nearby Places</a></li>
                 ...
                 <div class="col-sm-4 subscribe">
                    ...
                    <button class="btn btn-default" type="submit" onclick=alert("Subscribed")>Get Notify</button>
                    </span>
                    </div>
                    <div class="social">
...
<div class="text-center copyright">Powered by Phoenix Studios</div>
