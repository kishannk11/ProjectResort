...
<div class="row">
  ...
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/grk/grk1.jpg" class="img-responsive"><div class="info"><h3>GRK Resort</h3><p>Cherish new beginning and hoilday with GRK Resort at the best location in <b>Sakleshpura</b></p><a href="room-details-grk.php" class="btn btn-default">Check Details</a></div></div></div>
  ...
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/riveredge/river1.jpg" class="img-responsive"><div class="info"><h3>River Edge</h3><p>[Contents Needed]</p><a href="room-details-riveredge.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/greenview/greenview1.jpg" class="img-responsive"><div class="info"><h3>Greenview Homestay</h3><p>[Contents Needed]</p><a href="room-details-greenview.php" class="btn btn-default">Check Details</a></div></div></div>
