    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown"> Hi test Message</h1>
...
<div class="row">
  ...
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/pinkpatch/pp1.jpeg" class="img-responsive"><div class="info"><h3>Kushalnagar</h3><p>Perfect Place to spend the weekend. Swimming Pool Available</p><a href="room-details-pinkpatch.php" class="btn btn-default">Check Details</a></div></div></div> 
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/dweepa/dweepa1.jpg" class="img-responsive"><div class="info"><h3>Hassan</h3><p>Surronded with good scenic location, also private island </p><a href="room-details-dweepa.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/riveredge/river1.jpg" class="img-responsive"><div class="info"><h3>Kushalnagar</h3><p>Cherish your moments with nature for a perfect holiday. Swimming Pool and other activities are available</p><a href="room-details-riveredge.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/greenview/greenview1.jpg" class="img-responsive"><div class="info"><h3>Virajpet</h3><p>An oasis amidst serene lush green nature with a Dreamy Sunrise</p><a href="room-details-greenview.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/bhagyashree/bhagya1.jpg" class="img-responsive"><div class="info"><h3>Virajpet</h3><p>Feel the nature on every moment of the stay. </p><a href="room-details-bhagyashree.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/mounavana/mouna1.jpg" class="img-responsive"><div class="info"><h3>Theerthahalli</h3><p>Well located place so that you can enjoy the nature. Nearer to Agumbe View point, so that you can feel the essence of the most beautiful Sunset</p><a href="room-details-mounavana.php" class="btn btn-default">Check Details</a></div></div></div>
