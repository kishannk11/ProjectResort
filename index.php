...
<div class="row">
  ...
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/Eagle1.jpg" class="img-responsive"><div class="info"><h3>GRK Resort</h3><p>Cherish new beginning and hoilday with GRK Resort at the best location in <b>Sakleshpura</b></p><a href="room-details.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/Nanjun1.jpg" class="img-responsive"><div class="info"><h3>Pink Patch Resort</h3><p> [Contents Needed]</p><a href="room-details.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/Naveen1.jpg" class="img-responsive"><div class="info"><h3>Dweepa Resort</h3><p>[Contents Needed]</p><a href="room-details.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/Eagle1.jpg" class="img-responsive"><div class="info"><h3>Mounavana Cottage</h3><p>[Contents Needed]</p><a href="room-details.php" class="btn btn-default">Check Details</a></div></div></div>
  <div class="col-sm-6 wowload fadeInUp"><div class="rooms"><img src="images/photos/Nanjun1.jpg" class="img-responsive"><div class="info"><h3>Homestay 8</h3><p>[Contents Needed]</p><a href="room-details.php" class="btn btn-default">Check Details</a></div></div></div>
</div>
