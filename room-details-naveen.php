...
<h1 class="title">Naveen Homestay</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="images/photos/Naveen1.jpg" class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="images/photos/Naveen2.jpg"  class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="images/photos/Naveen3.jpg"  class="img-responsive" alt="slide"></div>
				<div class="item  height-full"><img src="images/photos/Naveen4.jpg"  class="img-responsive" alt="slide"></div>
				<div class="item  height-full"><img src="images/photos/Naveen5.jpg"  class="img-responsive" alt="slide"></div>
                </div>
                <!-- Controls -->
